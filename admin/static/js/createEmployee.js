document.addEventListener("DOMContentLoaded", function () {
  ...
  const inputs = [nameField, surnameField, addressField, localityField, emergencyContactNameField, obraSocialField, affiliateNumberField];
  inputs.forEach((e) => {
  ...
  function deactivateError(field) {
    ...
    console.log(validos, MAXVALIDOS)
